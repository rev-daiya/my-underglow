...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT( \
    ...
    LCTL_T(KC_TAB),  KC_A,    KC_S,    KC_D,    KC_F,           KC_G,            KC_RBRC,                 KC_BSLS,        KC_H,     KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
    LALT(KC_SPC), KC_Z, KC_X,  KC_C,    KC_V,           KC_B,            KC_EQL,                  KC_MINS,        KC_N,     KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RO, \
    KC_LGUI, TG(RGB), XXXXXXX, KC_LALT, RCTL_T(KC_GRV), LT(SYMB,KC_SPC), KC_LSFT,                 LT(META,KC_ESC),KC_BSPC,  KC_ENT, KC_RSFT, XXXXXXX, KC_RALT, KC_RGUI \
  ),
