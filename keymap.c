...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [BASE] = LAYOUT( \
    KC_DELT,  KC_Q,    KC_W,    KC_E,    KC_R,     KC_T,  LGUI(KC_PSCREEN),           XXXXXXX,   KC_Y,   KC_U,    KC_I,    KC_O,   KC_P, KC_LBRC, \
    KC_TAB, KC_A,    KC_S,    KC_D,    KC_F,     KC_G,  KC_RBRC,                    KC_BSLS,   KC_H,   KC_J,    KC_K,    KC_L,   KC_SCLN, KC_QUOT, \
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,     KC_B,  KC_JYEN,                    KC_EQL,    KC_N,   KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RO, \
    KC_LGUI, TG(RGB), XXXXXXX, KC_LALT, CTL_T(KC_ZKHK), LT(SYMB,KC_SPC), KC_BSPC,    RALT(KC_ESC), TO(META), RGUI(KC_ENT), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT \
  ),
  ...
  [META] = LAYOUT( \
    ...
    _______, KC_F11,  KC_F12, KC_MHEN, KC_HENK, XXXXXXX, XXXXXXX,      XXXXXXX,   KC_LEFT,  KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, _______, \
   ...
   */
  [SYMB] = LAYOUT( \
    _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,   KC_RBRC,    KC_BSLS,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, _______, \
    _______, S(KC_1), S(KC_2), S(KC_3), S(KC_4), S(KC_5), S(KC_8),    S(KC_9),    S(KC_6), S(KC_7), S(KC_8), S(KC_9), S(KC_0), _______, \
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, S(KC_RBRC), S(KC_BSLS), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, \
