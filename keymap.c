...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT( \
    ...
    KC_LGUI, TG(RGB), _______, KC_LALT, LCTL_T(KC_GRV), LT(SYMB,KC_SPC), KC_BSPC,                 RSFT_T(KC_ESC), MO(META), KC_ENT, KC_RGUI, KC_RALT, _______, KC_RCTL \
  ),
  ...
  [META] = LAYOUT( \
    ...
    _______, XXXXXXX, XXXXXXX, KC_MHEN, KC_HENK, XXXXXXX, XXXXXXX,      XXXXXXX,   KC_LEFT,  KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, KC_F12, \
