...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT( \
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,           KC_B,            KC_EQL,                  KC_MINS,        KC_N,     KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RO, \
    KC_LGUI, TG(RGB), _______, LALT_T(KC_GRV), KC_LCTL, LT(SYMB,KC_SPC), KC_LSFT,                LT(META,KC_ESC), KC_BSPC, KC_ENT, _______, _______, KC_RALT, KC_RGUI \
  ),
  ...
  [SYMB] = LAYOUT( \
    ...
    _______, KC_MINS, S(KC_MINS), KC_EQL,  S(KC_EQL), S(KC_JYEN), _______,     _______, XXXXXXX, XXXXXXX, _______, _______, _______, _______, \
